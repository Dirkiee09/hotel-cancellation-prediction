...
separate manual command and produces a 12-notebook PH suite under
`notebooks/ph/`.
...
contribution in 11 and CV comparison in 12.

Bootstrap 95 % CIs on PR-AUC span roughly ±15 percentage points at n_test = 20,
so the PH metrics are *directional*, not headlines.
